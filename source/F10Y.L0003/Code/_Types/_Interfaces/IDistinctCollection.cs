...
{
    /// <summary>
    /// Indicates (but does not guarantee) that a collection contains distinct elements.
    ...
    /// </remarks>
    [UtilityTypeMarker]
    public interface IDistinctCollection<T> : ICollection<T>, IDistinctEnumerable<T>
    {
    }
}
